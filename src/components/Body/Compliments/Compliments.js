...
const Compliments = () => {
  const complimentsList = [
    ...
    "Твоё горячее дыхание, каждый раз встречает меня в тёплом душе, когда я представляю тебя рядом с собой",
    "Ты определённо одна из самых лучших девушек, которых я встречал за послелний год",
  ];
